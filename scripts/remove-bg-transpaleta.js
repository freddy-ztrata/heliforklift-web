/* eslint-disable */
// Procesa las imagenes de la transpaleta CBD1520 (campana 4):
// 65.png -> heli-transpaleta-cbd1520-hero.png (vista 3/4)
// 67.png -> heli-transpaleta-cbd1520-side.png (vista lateral)
// Elimina fondo blanco y guarda como PNG transparente en public/assets/promo/.
...
const SRC_DIR = path.join(
  ...
  "assets",
  "Campañas",
  "Transpaleta Electrica - CBD1520"
);
const OUT_DIR = path.join(ROOT, "public", "assets", "promo");

const FILES = [
  { input: "65.png", output: "heli-transpaleta-cbd1520-hero.png" },
  { input: "67.png", output: "heli-transpaleta-cbd1520-side.png" },
];
