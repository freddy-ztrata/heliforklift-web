...
import { contact, teamByBranch, strategicPartners } from "@/lib/data/company";
import {
  MapPin,
  Phone,
  Mail,
  ...
  return (
    <>
      ...
      <main className="pt-24">
        ...
        {/* ============================================================ */}
        <section className="bg-steel-900/30 py-16 sm:py-20">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    {branch.contacts.map((person) => {
                      ...
                      return (
                        <div
                          key={person.email}
                          className="rounded-2xl border border-steel-700/50 bg-steel-900 p-5 sm:p-6 transition-all hover:border-heli-red/40 hover:bg-steel-900/80"
                        >
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:py-20 sm:px-6 lg:px-8">
          <div className="mb-10 sm:mb-12 text-center">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-heli-red/10">
            ...
            <h2 className="font-heading mt-2 text-[clamp(2rem,5vw,3.5rem)] leading-none text-white">
              SOCIOS ESTRATÉGICOS Y PUNTOS DE VENTA
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-base text-steel-400">
              Trabajamos con una red de socios estratégicos en distintas
              regiones de Chile para llegar más cerca de ti.
            </p>
          </div>
              ...
              <div
                ...
                className={`flex flex-col rounded-2xl border p-6 sm:p-7 transition-all hover:-translate-y-1 ${
                  partner.isOwn
                    ...
                    : "border-steel-700/50 bg-steel-900/60 hover:border-heli-red/30 hover:bg-steel-900"
                }`}
              >
                ...
                <div className="space-y-2 text-sm">
                  <p className="flex items-start gap-2 text-steel-300">
                    <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-heli-red" />
                    <span>
                      {partner.address}
                      <br />
