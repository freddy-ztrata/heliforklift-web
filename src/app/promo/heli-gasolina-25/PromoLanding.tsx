...
function useCountdown(targetHours: number) {
  ...
  useEffect(() => {
    // Anclar el target a un múltiplo fijo desde el inicio del día para evitar
    // hidratación inconsistente. Usamos hoy + targetHours desde medianoche.
...
function StockCounter() {
  const totalStock = 10;
  const remainingStock = 7; // Estático (puedes editarlo desde acá)
...
function Hero() {
  ...
  const countdown = useCountdown(48); // 48hrs desde ahora
        ...
        <div className="mt-8 grid flex-1 grid-cols-1 items-center gap-8 lg:mt-0 lg:grid-cols-2">
          ...
          <motion.div style={{ y: textY }} className="relative z-10">
            ...
            >
              ...
              <br />
              <span className="text-heli-yellow">2.5 TONS</span>
            </motion.h1>
            ...
            >
              Potencia, eficiencia y confianza para tu operación.
              Diseñada para entregar máximo rendimiento, menor costo
              operativo y alta confiabilidad en trabajos intensivos.
            </motion.p>
...
const features = [
  {
    icon: Cog,
    title: "Motor K25",
    desc: "Potente y confiable. Tecnología japonesa Nissan probada en miles de operaciones.",
  },
  {
    icon: Weight,
    title: "2.5 Toneladas",
    desc: "Capacidad de carga ideal para logística, bodegas e industria.",
  },
  {
    icon: Disc3,
    title: "Neumáticos macizos",
    desc: "Mayor durabilidad y menor mantención. Sin pinchazos, sin pérdida de tiempo.",
  },
  {
    icon: ArrowUpDown,
    title: "Mástil triple 4.7 m",
    desc: "Elevación superior para mayor alcance vertical en bodegas modernas.",
  },
  {
    icon: Move,
    title: "Desplazador lateral",
    desc: "Más precisión y eficiencia al posicionar cargas sin mover la máquina.",
  },
  {
    icon: Armchair,
    title: "Asiento con suspensión",
    desc: "Mayor comodidad del operador en largas jornadas. Reduce fatiga.",
  },
];
...
function Showcase() {
  ...
  // (no debe tapar la maquina). Vista lateral 2.5T.
  const hotspots = [
    {
    ...
    {
      // Pill a la izquierda para no tapar la maquina (rueda esta en mitad inferior)
            ...
            {hotspots.map((h, i) => (
              <motion.div
                ...
                style={{
                  ...
                  // Right: dot al inicio (translate -8px para alinear el centro del dot al X exacto)
                  // Left: dot al final (translate calc para que el dot termine en dotX)
                  transform:
                    h.pillSide === "right"
                      ? "translate(-8px, -50%)"
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          <div>
            ...
            <p className="mt-4 text-base text-steel-400">
              La HELI Gasolina 2.5 tons es la solución versátil para
              operaciones que necesitan rendimiento sostenido y bajo costo
              operativo.
            </p>
          </div>
...
const HUBSPOT_FORM_ID = "66a0f2cc-6e53-4755-ac9a-f07ba6732e2a";
