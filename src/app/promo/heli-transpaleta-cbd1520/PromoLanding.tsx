...
const PRODUCT_IMAGE_HERO = "/assets/promo/heli-transpaleta-cbd1520-hero.webp";
const PRODUCT_IMAGE_SIDE = "/assets/promo/heli-transpaleta-cbd1520-side.webp";
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid flex-1 grid-cols-1 items-center gap-8 lg:mt-0 lg:grid-cols-2">
          ...
          <motion.div style={{ y: textY }} className="relative z-10 order-2 lg:order-1">
            ...
            >
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-emerald-400">
                Litio 48V · La más potente del mercado
              </span>
            </motion.div>
            ...
            >
              ...
              <br />
              <span className="text-heli-yellow">2 TONS</span>
            </motion.h1>
            ...
            >
              Potencia de litio para máxima eficiencia. Compacta, ágil y
              confiable para mover hasta{" "}
              <strong className="text-white">2 toneladas</strong> sin esfuerzo.
              La aliada perfecta para tu bodega, retail o centro de
              distribución.
            </motion.p>
            ...
            <motion.div
              ...
              className="mt-6 inline-flex flex-col gap-1 rounded-2xl border border-heli-red/30 bg-gradient-to-br from-heli-red/20 via-heli-red/10 to-transparent p-5 backdrop-blur"
            >
              <span className="text-xs font-bold uppercase tracking-widest text-heli-red-light">
                Precio promocional
              </span>
              <div className="flex items-baseline gap-2">
                <span className="font-heading text-[clamp(2.5rem,5vw,4rem)] leading-none text-white">
                  $950.000
                </span>
              ...
              <span className="text-xs text-steel-400">
                Stock disponible para entrega inmediata · Chile
              </span>
            </motion.div>
          ...
          >
            ...
            >
              <div className="flex h-24 w-24 flex-col items-center justify-center rounded-full bg-emerald-500 text-white shadow-2xl sm:h-32 sm:w-32">
...
// ============================================================
// FEATURES — 6 spec cards (transpaleta-specific)
// ============================================================
const features = [
  {
    icon: Weight,
    title: "Capacidad 2 toneladas",
    desc: "La más potente del mercado. Mueve cargas pesadas sin esfuerzo y con total seguridad.",
  },
  {
    icon: BatteryCharging,
    title: "Batería de litio 48V/20Ah",
    desc: "Alta autonomía y carga rápida. Sin mantenimiento como las baterías de plomo-ácido.",
  },
  {
    icon: Ruler,
    title: "Horquillas 1150 x 685 mm",
    desc: "Dimensiones estándar para todos los pallets. Compatible con tu operación actual.",
  },
  {
    icon: Cpu,
    title: "Controlador Smart",
    desc: "Tecnología inteligente que optimiza el rendimiento y prolonga la vida útil de la batería.",
  },
  {
    icon: Sparkles,
    title: "Compacta y ágil",
    desc: "Diseño optimizado para pasillos estrechos. Perfecta para retail y bodegas con espacio limitado.",
  },
  {
    icon: ShieldCheck,
    title: "Confiabilidad HELI",
    desc: "Marca #1 mundial en montacargas con +65 años de experiencia. Repuestos disponibles en Chile.",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <h2 className="font-heading mt-3 text-[clamp(2rem,5vw,3.5rem)] leading-none text-white">
            DISEÑADA PARA
            <br />
            <span className="text-heli-red">TRABAJAR DURO</span>
          </h2>
          <p className="mt-4 text-base text-steel-400">
            Cada componente está pensado para entregarte máxima eficiencia
            y reducir tu costo operativo en bodegas y centros de distribución.
          </p>
        </motion.div>
...
// ============================================================
// SHOWCASE — vista lateral con cards
// ============================================================
function Showcase() {
  const ref = useRef<HTMLDivElement>(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });
  ...
  const specs = [
    {
      icon: BatteryCharging,
      title: "Litio 48V / 20Ah",
      desc: "Carga rápida sin memoria. Hasta 8 horas de operación continua sin recarga.",
    },
    {
      icon: Cpu,
      title: "Mango con control inteligente",
      desc: "Ergonomía premium. Controles intuitivos para máxima precisión en maniobras.",
    },
    {
      icon: Gauge,
      title: "Velocidad ajustable",
      desc: "Adapta la velocidad a cada operación. Mayor seguridad en pasillos estrechos.",
    },
  ];
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-heading mt-3 text-[clamp(2rem,5vw,4rem)] leading-none text-white">
            POTENCIA QUE
            <br />
            <span className="text-heli-red">NO SE CANSA</span>
          </h2>
          <p className="mt-4 text-base text-steel-400">
            Cada detalle pensado para que tu equipo trabaje más, mejor y con
            menos esfuerzo. Tecnología de litio que cambia el juego.
          </p>
        </motion.div>

        {/* Imagen central + cards laterales */}
        <motion.div
          style={{ y: imageY }}
          className="relative mt-12 grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-6"
        >
          {/* Cards lateral izquierda (2 cards) */}
            ...
            <div className="relative mx-auto aspect-square w-full max-w-3xl">
              ...
              >
                <Image
                  ...
                  alt="Transpaleta Eléctrica HELI CBD15/20 vista lateral"
                  fill
                  quality={90}
                  className="object-contain drop-shadow-[0_30px_60px_rgba(206,20,45,0.5)]"
        ...
        >
          {[
            { value: "2T", label: "Capacidad" },
            { value: "48V", label: "Batería litio" },
            { value: "1150mm", label: "Horquillas" },
...
// ============================================================
// BENEFITS — 4 grandes diferenciadores
// ============================================================
const benefits = [
  {
    icon: ShieldCheck,
    title: "Calidad y respaldo HELI",
    desc: "HELI es el #1 mundial en equipos de manejo de materiales. Más de 65 años de experiencia y presencia en 180 países.",
    stat: "+65 años",
  ...
  },
  {
    ...
    desc: "Batería de litio sin mantenimiento. Sin combustibles, sin emisiones, sin ruido. Operación 100% eléctrica.",
    stat: "0%",
    statLabel: "emisiones",
  },
  {
    ...
    desc: "Respaldo y soporte técnico nacional. Sucursales y socios estratégicos en todo Chile.",
    stat: "1 año",
  ...
  },
  {
    ...
    desc: "Stock disponible en Chile para entrega rápida. Recibe tu equipo y empieza a operar de inmediato.",
    stat: "48 hrs",
...
// ============================================================
// USE CASES — donde funciona la transpaleta
// ============================================================
const useCases = [
  ...
  "E-commerce y fulfillment",
  "Talleres y manufactura ligera",
];
        ...
        >
          <div>
            ...
            <h2 className="font-heading mt-3 text-[clamp(2rem,5vw,3.5rem)] leading-none text-white">
              IDEAL PARA TU
              <br />
              <span className="text-heli-red">OPERACIÓN</span>
            </h2>
            <p className="mt-4 text-base text-steel-400">
              La Transpaleta Eléctrica HELI CBD15/20 es la solución silenciosa,
              limpia y eficiente para mover pallets en cualquier ambiente —
              desde tiendas hasta bodegas industriales.
            </p>
          </div>
...
// ============================================================
// Formulario de Hapee "Promo Transpaleta CBD15/20 — HELI". Redirige a /promo/heli-transpaleta-cbd1520/gracias,
// donde se dispara el Lead del Pixel.
const HAPEE_FORM_ID = "heliforklift chile/contacto-home-heli-forklift-chile-copia";
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && window.fbq) {
      window.fbq("trackCustom", "ViewContent", {
        content_name: "promo_transpaleta_2t",
        content_category: "transpaleta_electrica",
        content_ids: ["heli-transpaleta-cbd1520"],
      });
    }
  }, []);
