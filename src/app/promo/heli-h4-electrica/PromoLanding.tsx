  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <p className="text-xs font-bold uppercase tracking-widest text-heli-red-light">
        Solo {remainingStock} unidades con financiamiento en 12 cuotas
      </p>
    </div>
  );
}
...
// ============================================================
// OFFER STRIP — gancho principal: 12 cuotas precio al contado
// ============================================================
function OfferStrip() {
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-heli-yellow/30 bg-gradient-to-r from-heli-yellow/15 via-heli-yellow/5 to-transparent p-4 backdrop-blur">
      <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-heli-yellow/20 ring-1 ring-heli-yellow/40">
        <CreditCard className="h-6 w-6 text-heli-yellow" />
      </div>
      <div>
        <p className="font-heading text-lg leading-none text-white sm:text-xl">
          12 CUOTAS AL PRECIO DE CONTADO
        </p>
        <p className="mt-1 text-xs text-steel-300">
          Financia tu grúa eléctrica sin interés ni recargo
        </p>
      </div>
    </div>
  );
          ...
          <motion.div style={{ y: textY }} className="relative z-10 order-2 lg:order-1">
            ...
            >
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-heli-yellow">
                Oferta especial · 12 cuotas precio contado
              </span>
            </motion.div>
            ...
            >
              ...
              <br />
              <span className="text-heli-yellow">SERIE H4</span>
            </motion.h1>
            ...
            >
              Versatilidad y rendimiento para operaciones de mediana intensidad.
              Batería <strong className="text-white">Litio-ion 80V</strong>,
              cero emisiones y carga rápida oportunista. Disponible de{" "}
              <strong className="text-white">2.5 a 3.5 toneladas</strong>.
            </motion.p>
...
const features = [
  {
    icon: Battery,
    title: "Batería Litio-ion 80V",
    desc: "Alto voltaje para máxima potencia, sin mantención de batería y con una vida útil muy superior al plomo-ácido.",
  },
  {
    icon: Weight,
    title: "2.5 a 3.5 toneladas",
    desc: "Rango extendido de capacidades para cubrir operaciones de mediana intensidad con un solo equipo.",
  },
  {
            ...
            <div className="relative mx-auto aspect-[4/3] w-full max-w-3xl">
              ...
              >
                <Image
                  ...
                  alt="Grúa Eléctrica HELI Serie H4 con cargador de batería de litio"
                  fill
                  quality={90}
                  className="object-contain drop-shadow-[0_30px_60px_rgba(206,20,45,0.5)]"
...
// ============================================================
// BENEFITS — 4 grandes diferenciadores (incluye 12 CUOTAS)
// ============================================================
const benefits = [
  {
    icon: CreditCard,
    title: "12 cuotas al precio de contado",
    desc: "Financia tu grúa eléctrica en 12 cuotas pagando el mismo precio que al contado. Sin interés, sin recargo, sin letra chica.",
    stat: "12 cuotas",
    statLabel: "sin interés",
  },
  {
    icon: ShieldCheck,
  ...
  return (
    <section className="relative overflow-hidden bg-steel-950 py-20 sm:py-24">
      ...
      >
        <Image
          src={PRODUCT_IMAGE_HERO}
          alt="Grúa Horquilla Eléctrica HELI Serie H4 — vista lateral"
          fill
          quality={85}
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          <div>
            ...
            <p className="mt-4 text-base text-steel-400">
              La HELI Eléctrica Serie H4 es la solución limpia y versátil para
              operaciones de mediana intensidad que requieren cero emisiones y
              disponibilidad turno tras turno.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1.3fr] lg:gap-12">
          ...
          <div>
            ...
            <p className="mt-5 text-base leading-relaxed text-steel-300">
              Cotiza hoy tu grúa eléctrica HELI Serie H4 y llévala en{" "}
            ...
            <div className="mt-6 space-y-3">
              {[
                {
                  icon: CreditCard,
                  text: "12 cuotas al precio de contado, sin interés",
                },
                {
                  icon: Zap,
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && window.fbq) {
      window.fbq("trackCustom", "ViewContent", {
        content_name: "promo_h4_electrica",
        content_category: "electrica",
        content_ids: ["heli-h4-electrica"],
      });
    }
  }, []);
