...
// Fin de la oferta: 15 de julio de 2026 (o hasta agotar stock).
const OFFER_DEADLINE = "2026-07-15T23:59:59";

// ============================================================
// COUNTDOWN — sentido de urgencia (hacia el 15 de julio)
// ============================================================
      ...
      <div className="flex flex-wrap justify-center gap-1">
        {Array.from({ length: totalStock }).map((_, i) => (
          <motion.div
            ...
            className={
              i < remainingStock
                ? "h-2 w-5 rounded-full bg-heli-red shadow-[0_0_12px_rgba(206,20,45,0.6)] transition-all"
                : "h-2 w-5 rounded-full bg-steel-700 transition-all"
            }
          />
        ))}
      </div>
      <p className="text-xs font-bold uppercase tracking-widest text-heli-red-light">
        Solo {remainingStock} unidades con -30% de descuento
      </p>
    </div>
  );
}
...
// ============================================================
// OFFER STRIP — gancho principal: -30% de descuento
// ============================================================
function OfferStrip() {
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-heli-yellow/30 bg-gradient-to-r from-heli-yellow/15 via-heli-yellow/5 to-transparent p-4 backdrop-blur">
      <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-heli-yellow/20 ring-1 ring-heli-yellow/40">
        <Percent className="h-6 w-6 text-heli-yellow" />
      </div>
      <div>
        ...
        <p className="mt-1 text-xs text-steel-300">
          En tu grúa eléctrica H4 2.5T · hasta el 15 de julio o agotar stock
        </p>
      </div>
    </div>
  );
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid flex-1 grid-cols-1 items-center gap-8 lg:mt-0 lg:grid-cols-2">
          ...
          <motion.div style={{ y: textY }} className="relative z-10 order-2 lg:order-1">
            ...
            >
              Modelo{" "}
              <strong className="text-white">CPD25-A3LiH4-M</strong>: versatilidad
              y rendimiento para operaciones de mediana intensidad. Batería{" "}
              <strong className="text-white">Litio-ion 80V / 302 Ah</strong>, cero
              emisiones y carga rápida. Capacidad de{" "}
              <strong className="text-white">2.500 kg</strong> y elevación hasta{" "}
              <strong className="text-white">4.700 mm</strong>.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <span className="relative">Cotizar con -30%</span>
...
const features = [
  {
    icon: Battery,
    title: "Batería Litio-ion 80V / 302 Ah",
    desc: "Alto voltaje para máxima potencia, sin mantención de batería y con una vida útil muy superior al plomo-ácido.",
  },
  {
    icon: Weight,
    title: "Capacidad 2.500 kg",
    desc: "Rango extendido de 2.5 toneladas para cubrir operaciones de mediana intensidad con un solo equipo.",
  },
  {
    icon: BatteryCharging,
    title: "Carga rápida oportunista",
    desc: "Recarga en pausas y descansos sin retirar la batería. Opera en múltiples turnos sin tiempos muertos.",
  },
  {
    icon: ArrowUpDown,
    title: "Elevación hasta 4.700 mm",
    desc: "Altura de mástil para optimizar el almacenamiento en altura en bodegas y centros de distribución.",
  },
  {
    icon: Leaf,
    title: "Cero emisiones",
    desc: "Ideal para interiores: sin gases ni humo. Un ambiente de trabajo más limpio, silencioso y seguro.",
  },
  {
    icon: Armchair,
    title: "Diseño ergonómico avanzado",
    desc: "Mayor comodidad y visibilidad para el operador. Menos fatiga en jornadas largas y más productividad.",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <h2 className="font-heading mt-3 text-[clamp(2rem,5vw,3.5rem)] leading-none text-white">
            POTENCIA ELÉCTRICA
            <br />
            <span className="text-heli-red">SIN COMPROMISOS</span>
          </h2>
...
// ============================================================
// SHOWCASE — vista de la maquina con cargador de litio
// ============================================================
function Showcase() {
  const ref = useRef<HTMLDivElement>(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });
  ...
  const specs = [
    {
      icon: Battery,
      title: "Litio-ion 80V / 302 Ah",
      desc: "Sin mantención de batería, mayor vida útil y máxima potencia disponible.",
    },
    {
      icon: BatteryCharging,
      title: "Carga oportunista",
      desc: "Recarga en pausas sin retirar la batería. Lista para múltiples turnos.",
    },
    {
      icon: Leaf,
      title: "Cero emisiones",
      desc: "Perfecta para interiores: sin gases, sin humo, baja sonoridad.",
    },
  ];
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-base text-steel-400">
            La Serie H4 combina la batería de litio con carga oportunista para
            que tu operación funcione turno tras turno, sin tiempos muertos.
          </p>
        </motion.div>
            ...
            <div className="relative mx-auto aspect-[4/3] w-full max-w-3xl">
              ...
              >
                <Image
                  ...
                  alt="Grúa Eléctrica HELI Serie H4 2.5T con cargador de batería de litio"
                  fill
                  quality={90}
                  className="object-contain drop-shadow-[0_30px_60px_rgba(206,20,45,0.5)]"
...
// ============================================================
// BENEFITS — 4 grandes diferenciadores (incluye -30%)
// ============================================================
const benefits = [
  {
    icon: Percent,
    title: "30% de descuento",
    desc: "Aprovecha el 30% de descuento sobre el valor de lista en tu grúa eléctrica H4 2.5T. Oferta válida hasta el 15 de julio o hasta agotar stock.",
    stat: "-30%",
    statLabel: "hasta el 15 jul",
  },
  {
    icon: ShieldCheck,
    title: "Respaldo HELI #1 mundial",
    desc: "HELI es el fabricante de grúas horquilla #1 a nivel mundial, con más de 67 años de experiencia y presencia en 180+ países.",
    stat: "+67 años",
  ...
  },
  {
    ...
    desc: "Stock disponible en Chile para entrega rápida. Solo 15 unidades con esta oferta — no esperes meses como con otras marcas.",
    stat: "Stock",
  ...
  return (
    <section className="relative overflow-hidden bg-steel-950 py-20 sm:py-24">
      ...
      >
        <Image
          src={PRODUCT_IMAGE_HERO}
          alt="Grúa Horquilla Eléctrica HELI Serie H4 2.5T — vista lateral"
          fill
          quality={85}
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          <div>
            ...
            <p className="mt-4 text-base text-steel-400">
              La HELI Eléctrica Serie H4 2.5T es la solución limpia y versátil
              para operaciones de mediana intensidad que requieren cero emisiones
              y disponibilidad turno tras turno.
            </p>
          </div>
...
// ============================================================
// Formulario de Hapee "Promo Eléctrica H4 2.5T (CPD25) — HELI". Redirige a
// /promo/CPD25-A3LiH4-M/CPD25th, donde se dispara el Lead del Pixel.
const HAPEE_FORM_ID = "heliforklift chile/contacto-home-heli-forklift-chile-copia-8";
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1.3fr] lg:gap-12">
          ...
          <div>
            ...
            <p className="mt-5 text-base leading-relaxed text-steel-300">
              Cotiza hoy tu grúa eléctrica HELI Serie H4 2.5T con{" "}
              <strong className="text-white">30% de descuento</strong>. Completa
              el formulario y te contactamos en menos de{" "}
            ...
            <div className="mt-6 space-y-3">
              {[
                {
                  icon: Percent,
                  text: "30% de descuento hasta el 15 de julio",
                },
                {
                  icon: Zap,
