...
const PRODUCT_IMAGE_HERO = "/assets/promo/heli-diesel-k2-25t-hero.png";
const PRODUCT_IMAGE_SIDE = "/assets/promo/heli-diesel-k2-25t-side.png";
...
// ============================================================
// STOCK COUNTER — visualización de escasez (10 unidades)
// ============================================================
          ...
          <motion.div style={{ y: textY }} className="relative z-10">
            ...
            >
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-heli-yellow">
                Stock limitado · Solo 10 unidades
              </span>
            </motion.div>
            ...
            >
              ...
              <br />
              <span className="text-heli-yellow">DIESEL · 2.5 TONS</span>
            </motion.h1>
            ...
            <motion.div
              ...
              className="mt-3 inline-flex items-center gap-2 rounded-full border border-heli-red/40 bg-heli-red/10 px-3 py-1.5"
            >
              <Fuel className="h-3.5 w-3.5 text-heli-red-light" />
              <span className="text-xs font-bold uppercase tracking-widest text-heli-red-light">
                Motor Diesel · Modelo K2
              </span>
            </motion.div>
            ...
            >
              ...
              para entregar máximo rendimiento, menor costo operativo y alta
              confiabilidad en trabajos intensivos.
            </motion.p>
...
// ============================================================
// FEATURES — 6 spec cards
// ============================================================
const features = [
  {
    icon: Fuel,
    title: "Motor Diesel",
    desc: "Mayor potencia, rendimiento y durabilidad. Tecnología Yanmar/Kubota probada en operaciones intensivas.",
  },
  {
    icon: Weight,
    title: "2.5 Toneladas",
    desc: "Capacidad de carga ideal para logística, bodegas e industria. La medida más versátil del mercado.",
  },
  {
    icon: Disc3,
    title: "Neumáticos macizos",
    desc: "Mayor durabilidad y menor mantención. Sin pinchazos, sin pérdida de tiempo en operación.",
  },
  {
    icon: Move,
    title: "Desplazador lateral",
    desc: "Más precisión y eficiencia al posicionar cargas sin necesidad de mover toda la máquina.",
  },
  {
    icon: ArrowUpDown,
    title: "Mástil triple 4.7 m",
    desc: "Elevación superior para mayor alcance vertical en bodegas y centros de distribución modernos.",
  },
  {
    icon: Armchair,
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <h2 className="font-heading mt-3 text-[clamp(2rem,5vw,3.5rem)] leading-none text-white">
            DISEÑADA PARA
            <br />
            <span className="text-heli-red">RENDIR AL MÁXIMO</span>
          </h2>
...
function Showcase() {
  ...
  const specs = [
    ...
    {
      icon: Fuel,
      title: "Motor Diesel K2",
      desc: "Yanmar/Kubota con transmisión powershift. Máxima durabilidad y bajo consumo.",
    },
    {
      icon: Disc3,
      title: "Neumáticos macizos",
            ...
            <div className="relative mx-auto aspect-square w-full max-w-3xl">
              ...
              >
                <Image
                  ...
                  alt="HELI CPCD25-Q13K2 Diesel vista lateral"
                  fill
                  quality={90}
                  className="object-contain drop-shadow-[0_30px_60px_rgba(206,20,45,0.5)]"
...
const benefits = [
  ...
  },
  {
    ...
    desc: "Eficiencia comprobada en consumo y mantenimiento. Hasta 30% más económica que la competencia.",
    stat: "30%",
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          <div>
            ...
            <p className="mt-4 text-base text-steel-400">
              La HELI CPCD25-Q13K2 Diesel 2.5 tons es la solución versátil
              para operaciones que requieren rendimiento sostenido y bajo
              costo operativo.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1.3fr] lg:gap-12">
          <div>
            ...
            <p className="mt-5 text-base leading-relaxed text-steel-300">
              Solo <strong className="text-white">10 unidades disponibles</strong>{" "}
              a precio promocional. Cuando se acaben, vuelve al precio
              regular. Completa el formulario y te contactamos en menos de{" "}
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && window.fbq) {
      window.fbq("trackCustom", "ViewContent", {
        content_name: "promo_diesel_25t",
        content_category: "diesel",
        content_ids: ["heli-diesel-k2-25t"],
      });
    }
  }, []);
